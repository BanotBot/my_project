<div class="main-content">
    ...
    <div class="row">
                        ...
                        <div class="col-12 col-xl-12">
                            <div class="card rounded-4 mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <p class="mb-2 d-flex align-items-center justify-content-between">285 left
                                            to Goal<span class="">78%</span></p>
        ...
        <div class="col-12 col-xl-7 col-xxl-5 d-flex">
            <div class="card w-100 rounded-4">
                <div class="card-body">
                    ...
                    <div id="chart4"></div>
                    <div class="d-flex align-items-start justify-content-around bg-light p-3 rounded-4 mt-3">
                        <div class="">
